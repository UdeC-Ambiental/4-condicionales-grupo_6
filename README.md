...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=21201005&assignment_repo_type=AssignmentRepo)
...
| `reto1_temperatura.ipynb` | Clasificación térmica y riesgo | Julian |
| `reto2_ph.ipynb` | Evaluación de pH y alerta química | Camila |
| `reto3_oxigeno.ipynb` | Análisis biológico por oxígeno | Jackson |
| `reto4_integracion.ipynb` | Diagnóstico final integrando variables | Jackson |
